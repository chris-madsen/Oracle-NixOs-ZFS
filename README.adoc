...
// Lead paragraph (введение без рамок)
...
// Сайдбар вместо красного Important - выглядит как нейтральный блок
.Why ZFS on Boot?
****
...
│   │   ├── decisions.md
│   │   ├── done.md
│   │   ├── errors_and_problems.md
│   │   ├── plan.md
│   │   └── todo.md
│   ├── consilium_execution_blueprint_v9.1.html
│   ├── consilium_execution_blueprint_v9.1.md
│   └── consilium_execution_blueprint_v9.1.pdf
├── scripts
